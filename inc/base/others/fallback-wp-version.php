...
if (!function_exists('daprods_skip_wp_admin_notice')) {
    /**
     ...
     */
    function daprods_skip_wp_admin_notice() {
...
add_action('admin_notices', 'daprods_skip_wp_admin_notice');
